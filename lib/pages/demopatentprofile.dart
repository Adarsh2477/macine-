...
import 'login.dart';
class demopatientProfile extends StatefulWidget {
  ...
  State<demopatientProfile> createState() => _demopatientProfileState();
}

class _demopatientProfileState extends State<demopatientProfile> {
  bool _loading = false;
...
//widget.userId
  ...
  Future<void> _logout() async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => demoligin()), // Navigate to your login page
    );
  }
