...
import 'button.dart';
import 'date_time_converted.dart';
class updateopdappoint extends StatefulWidget {

  // final Doctor doctor;
  final Patient patient;
  final appointmentview appintment;
  // final Appintment appint;
  const updateopdappoint(
  ...
  @override
  State<updateopdappoint> createState() => _updateopdappointState();
}

class _updateopdappointState extends State<updateopdappoint> {
  ...
  Future<dynamic> bookappintment2(
    ...
    var res=await http.post(Uri.parse(uri),body: {
      ...
      'ohc_type_id':widget.patient.ohc_type_id,
      'app_type':widget.appintment.type,
    });
    var jsonData = json.decode(res.body);
    setState(() {
      timelist = jsonData;
              ...
              child: Card(
                child:_dateSelected? DropdownButton(
                  ...
                  hint: Padding(
                    ...
                    child: Center(child: Text(widget.appintment.doctor_id.toString(),style: TextStyle(fontWeight:FontWeight.bold ))),
                  ),
