...
class _LineChart extends StatelessWidget {
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      case 2:
        bottomTitle = const Text('SEPT', style: style);
        break;
      case 7:
        bottomTitle = const Text('OCT', style: style);
        break;
      case 12:
        bottomTitle = const Text('DEC', style: style);
        break;
      case 15:
        bottomTitle = const Text('DM', style: style);
        break;
      default:
